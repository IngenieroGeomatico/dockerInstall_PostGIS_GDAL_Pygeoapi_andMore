...
su - postgres -c "/usr/lib/postgresql/${PG_Version_int}/bin/pg_ctl -D /var/lib/postgresql/data stop || echo 'No se encontró ninguna instancia en ejecución.'"



# Iniciar PostgreSQL con un tiempo de espera mayor
echo "Iniciando el servicio de PostgreSQL..."
su - postgres -c "/usr/lib/postgresql/${PG_Version_int}/bin/pg_ctl -D /var/lib/postgresql/data -l /var/lib/postgresql/logfile start -t 120 "
